...
def initialize_decision_variables(backend_model):
    ...
    degraded_storage      loc_techs_storage_degradation, timesteps
    ==================== ========================================
    ...
    if 'loc_techs_storage_degradation' in model_data_dict['sets']:
        backend_model.degraded_storage = po.Var(backend_model.loc_techs_storage_degradation, backend_model.timesteps, within=po.Reals)
